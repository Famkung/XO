...
const x = (i, j, site) => {
    if (player == 2) {
        ...
        document.getElementById('xo' + i + j).style.background = 'red';
        ...
        document.getElementById('xo' + i + j).style.background = 'blue';
        document.getElementById('xo' + i + j).disabled = true;
        const xmlhttp = new XMLHttpRequest();
        xmlhttp.onload = function() {
            document.getElementById("txtHint").innerHTML = this.responseText;
...
function replay2(i, j, play) {
    if (play == 'X') {
        document.getElementById('xx' + i + j).value = 'X';
        document.getElementById('xx' + i + j).style.background = 'Blue';
        document.getElementById('OO' + i + j).disabled = true;
    } else {
        document.getElementById('xx' + i + j).value = 'O';
        document.getElementById('xx' + i + j).style.background = 'red';
        document.getElementById('OO' + i + j).disabled = true;
    }
